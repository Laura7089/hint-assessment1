...
The ARINC664P7 specification~\cite{ARINC664P71AIRCRAFTDATA2009} is an existing alternative standard, with \keyword{AFDX} as the de-facto implementation of it~\cite{moreauxDataTransmissionSystem2005}.
